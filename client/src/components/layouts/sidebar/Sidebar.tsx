...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`w-full h-full md:w-80 border-r border-neutral-800 absolute top-0 left-0 bg-neutral-900 transition-all duration-300 flex flex-col gap-2 p-2 shrink-0
